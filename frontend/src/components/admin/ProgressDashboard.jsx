                  ...
                  <tr key={faculty.id} className="hover:bg-gray-50/30 transition-colors group">
                    ...
                    <td className="px-8 py-6 text-right align-top">
                      {percentage === 100 && faculty.summary_id ? (
                        ...
                        <div className="flex items-center justify-end gap-3 mt-3">
                          <button
                            className="px-4 py-2 bg-yellow-50 hover:bg-yellow-100 text-yellow-700 rounded-xl text-xs font-semibold transition-all disabled:opacity-60 disabled:cursor-not-allowed"
                          ...
                          <button
                            className="px-4 py-2 bg-gray-50 hover:bg-gray-100 text-brand-black rounded-xl text-xs font-semibold transition-all"
                      ...
                      <div className="mt-2">
                        <span className={`inline-flex items-center px-3 py-1 rounded-full text-xs font-bold ${percentage === 100
                  ...
                  {selectedNominations.nominations.map((nomination) => {
                    ...
                    return (
                      <div key={nomination.nomination_id} className="flex items-center justify-between rounded-2xl border border-gray-100 px-4 py-3">
                        ...
                        <span className={`inline-flex items-center rounded-full px-3 py-1 text-xs font-bold ${isApproved
                            ? 'bg-green-50 text-brand-green'
                            : isRejected
